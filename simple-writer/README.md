...
This is a sample template for simple-writer - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name simple-writer --query 'Stacks[].Outputs'
```
